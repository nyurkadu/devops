...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  provisioner "file" {
    source      = "${path.module}/index-file-provisioner.html"
    destination = "/tmp/index-file-provisioner.html"
  }
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo cp /tmp/index-file-provisioner.html /var/www/html/index.html",
